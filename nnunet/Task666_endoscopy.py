...
if __name__ == '__main__':
    ...
    base = 'G:/data/data_endo_split'
    # this folder should have the training and testing subfolders

    # now start the conversion to nnU-Net:
    task_name = 'Task666_EndoScopySeg'
    ...
    for t in training_cases:
        ...
        # output_image_file = output_image_file.replace('\t', '/t')
        # output_image_file = output_image_file.replace('\\', '/')
        # output_seg_file = output_seg_file.replace('\t', '/t')
        # output_seg_file = output_seg_file.replace('\\', '/')
        # input_segmentation_file = input_segmentation_file.replace('\t', '/t')
        # input_segmentation_file = input_segmentation_file.replace('\\', '/')
        # input_image_file = input_image_file.replace('\t', '/t')
        # input_image_file = input_image_file.replace('\\', '/')
        # this utility will convert 2d images that can be read by skimage.io.imread to nifti. You don't need to do anything.
        # if this throws an error for your images, please just look at the code for this function and adapt it to your needs
        # print(input_image_file, output_image_file)
