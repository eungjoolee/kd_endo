...
def train_model(total_epochs, save_dir,train_images,train_labels,val_images,val_labels):
    ...
    model = models.unet_2d((1024, 1280,3), [64, 128, 256, 512], n_labels=4,
                      ...
                      activation='GELU', output_activation='Softmax', backbone='VGG16', weights='imagenet',  
...
if __name__=="__main__":
    ...
    model_dir = "./ternausnet_parts/"
    
    print("data loaded!")
  
    train_model(total_epochs = 103, save_dir = model_dir,train_images = train_images_arr,train_labels = train_masks_arr,val_images=val_images_arr,val_labels=val_masks_arr)
